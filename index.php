...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap Plugin : BODY --> 
       
        <!-- Bootstrap Plugin : NAVIGATION BAR -->
					...
					<div class="row h-100">
						<div class="col-lg-7 my-auto">
							<div class="header-content mx-auto">
								...
								<a class="btn btn-outline-light py-3 px-4 rounded-pill js-scroll-trigger" href="#download " style="color:white;">Enquire Now!</a>
							</div>
						</div>
				...
				<div class="col-md-4 mb-5">
					<div class="card h-100">
						<div class="card-body">
							...
							<br /><br />
							<p class="card-text">The Apple M1 chip gives the 13‑inch MacBook Pro speed and power beyond belief. With up to 2.8x CPU performance. Up to 5x the graphics speed. Our most advanced Neural Engine for up to 11x faster machine learning. And up to 20 hours of battery life — the longest of any Mac ever. It’s our most popular pro notebook, on a whole new level.</p>
						</div>
						<div class="card-footer"><a class="btn btn-primary btn-sm" href="#!">Check Out all MacBooks</a></div>
					</div>
				</div>
			</div>
			...
			<section class="cta">
				<div class="cta-content">
					<div class="container">
						...
						<a class="btn btn-outline-light py-3 px-4 rounded-pill js-scroll-trigger" href="Aboutus.php" style="color:white;">About Us</a>
					</div>
				</div>
